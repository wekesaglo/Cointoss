...
function tallyScore(random, userPick, computerPick){
    ...
    } else if (userScore===5 && computerScore===0){
        winner.innerHTML = `<h1>You Win!!!</h1>`;
    } else if (userScore===4 && computerScore===1){
        winner.innerHTML = `<h1>You Win!!!</h1>`;
    } else if (userScore===3 && computerScore===2){
        winner.innerHTML = `<h1>You Win!!!</h1>`;
    } else if (userScore===2 && computerScore===3){
        winner.innerHTML = `<h1>Computer Wins!!!</h1>`;       
    } else if (userScore===1 && computerScore===4){
        winner.innerHTML = `<h1>Computer Wins!!!</h1>`;
    } else if (userScore===0 && computerScore===5){
        winner.innerHTML = `<h1>Computer Wins!!!</h1>`;
    } else if (userScore===0 && computerScore===0){
        winner.innerHTML = `<h1>Nobody Wins!!!</h1>`;    
} }
